...
<head>
    ...
    <style>
        ...
        .search-result-box {
            border: 2px solid #28a745; /* สีเขียวของกรอบ */
            border-radius: 5px; /* มุมมน */
            background-color: #e9ffe8; /* สีพื้นหลัง */
            padding: 15px;
            width: 400px;
            margin-top: 15px;
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="indexclam.php">Claim Reports</a>
                </div>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="form-row justify-content-center mb-3">
            <div class="button-group">
                ...
                <a href="create_client_group.php" class="btn btn-primary">Create Client Group</a>
        ...
        <div class="d-flex justify-content-center">
            <div class="search-result-box">
                <p class="mb-2"><strong>Search Result:</strong></p>
                <div class="row">
                    <div class="col-md-12">
